...
const fashionProducts: Product[] = [
  ...
  },
  {
    ...
    description: "Classic slim fit shirt with a clean look for all occasions.",
    price: 549,
    oldPrice: 1099,
    rating: 4,
  },
  ...
  },
  {
    ...
    description: "Elegant rayon embroidered kurta pant dupatta set for women.",
    price: 850,
    oldPrice: 1500,
    rating: 5,
  },
  {
    ...
    description: "Festive embroidered lehenga choli and dupatta set for girls.",
    price: 750,
    oldPrice: 1400,
    rating: 4,
  },
    ...
    <div className="productSlider">
      <Swiper
        ...
        breakpoints={{
          ...
          1280: { slidesPerView: items ?? 5, spaceBetween: 12 },
        }}
